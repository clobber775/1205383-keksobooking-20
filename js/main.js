  ...
  mainPinElement.addEventListener('mousedown', function (evt) {
    ...
    var onMouseMove = function (moveEvt) {
      ...
      /* if (moveEvt.pageX > limits.right) {
        mainPinElement.offsetLeft = limits.right;
      } else if (moveEvt.pageX > limits.left) {
        mainPinElement.offsetLeft = moveEvt.pageX;
      }
      if (moveEvt.pageY > limits.bottom) {
        mainPinElement.offsetTop = limits.bottom;
      } else if (moveEvt.pageY > limits.top) {
        mainPinElement.offsetTop = moveEvt.pageY;
      }
